...
GET_ConfButton              : '我已经保存 Keystore 文件，继续查看钱包信息。',
GEN_Label_5                 : '保存钱包`私钥`。 ',
GEN_Unlock                  : '解锁钱包查看钱包地址',
...
/* General */
x_Access                    : 'Access ',
x_AddessDesc                : '你可以把地址理解为你的『账户』或者『公钥』。你将地址告诉别人，他们就可以向你转账。',
x_Address                   : '你的地址 ',
x_Cancel                    : '拒绝 ',
x_CSV                       : 'CSV文件（未加密） ',
x_Download                  : '下载 ',
...
SUCCESS_1                   : '有效地址 ',
SUCCESS_2                   : '钱包解密成功 ',
SUCCESS_3                   : '交易已经发送到区块链网络。但这并意味着交易已经成功。TX Hash: ',
SUCCESS_4                   : '成功添加你的钱包： ',
SUCCESS_5                   : '选择的文件： ',
