        ...
        <table class="table small table-condensed table-hover">
          <tbody>
            ...
            <tr>
              ...
              <td class="small text-left mono">{{parsedSignedTx.value}} LDBC</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="small text-left mono">{{parsedSignedTx.gasPrice.gwei}} GWEI <small>({{parsedSignedTx.gasPrice.eth}} LDBC)</small>
              </td>
            </tr>
            <tr>
              <td class="small text-right">Max TX Fee:</td>
              <td class="small text-left mono"> {{parsedSignedTx.txFee.eth}} LDBC<small>({{parsedSignedTx.txFee.gwei}} GWEI)</small></td>
            </tr>
            <tr>
